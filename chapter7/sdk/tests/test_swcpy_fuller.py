...
def test_list_leagues():
    ...
    config = SWCConfig(url="https://api.sportsworldcentral.com")
    client = SWCClient(config)    
...
def test_list_players():
    ...
    players_response = client.list_players(skip=0,limit=2000)
